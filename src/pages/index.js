  ...
  return (
    <div className="container">
      <div>
        ...
        <p className="intro-paragraph">This is a Sleep Analysis tool meant to help you learn how to self-assess Pokemon that you catch in Pokemon Sleep. Depending on a Pokemon specialty, different buffs or debuffs can be beneficial. Enter your Pokemon details to learn more about them!</p>
      </div>
